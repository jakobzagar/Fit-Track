...
- `docs/release-process.md`: branches, commits, pull requests, image publication, migrations, versions, and releases.
- `docs/aws-deployment-plan.md`: current deployment readiness and planned AWS topology only.
- `CHANGELOG.md`: public release history generated by Release Please.
...
- Use Conventional Commits without scopes: `feat:`, `fix:`, `perf:`, `refactor:`, `test:`, `docs:`, `ci:`, `build:`, or `chore:` followed by a concise imperative summary.
...
- Do not manually edit product versions, the Release Please manifest, or the changelog during ordinary work. Release Please owns and coordinates these artifacts.
...
- Follow the [pull request scope and description guide](docs/release-process.md#pull-request-scope-and-description) for human-authored PRs. Leave generated Dependabot and Release Please descriptions to their tools.
