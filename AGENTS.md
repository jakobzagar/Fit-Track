...
- `CHANGELOG.md`: public release history generated by Release Please starting with the first release.
...
- Do not manually edit product versions or the changelog during ordinary work. The coordinated package version `0.0.0`, empty Release Please manifest, and empty release history mark the unreleased repository state; Release Please owns these files starting with the first release.
