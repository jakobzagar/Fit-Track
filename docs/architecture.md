...
All three TypeScript workspaces use `strict` checking, `noUncheckedIndexedAccess`, and `exactOptionalPropertyTypes`; the frontend applies these settings to both its application and Node/E2E projects.
